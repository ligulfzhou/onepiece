package com.hzqianxun.my_thread_test.base;
...
import com.hzqianxun.my_thread_test.bean.Entity;
import com.hzqianxun.my_thread_test.bean.Result;
import com.hzqianxun.my_thread_test.ui.empty.EmptyLayout;
...
//            }
    ...
    protected void executeOnLoadDataSuccess(List<T> data) {
        ...
        if (mResult != null && !mResult.OK()) {
            AppContext.showToast(mResult.getErrmsg());
...
//            AppContext.getInstance().Logout();
    ...
    protected boolean compareTo(List<? extends Entity> data, Entity enity) {
        ...
        if (enity != null) {
            for (int i = 0; i < s; i++) {
                if (enity.get_id() == data.get(i).get_id()) {
                    return true;
                }
            }
        }
...
//                        reponseData));
                List<T> data = parseList(new ByteArrayInputStream(reponseData));

package com.hzqianxun.my_thread_test.api.remote;
...
//    }
    ...
    public static void getThreadList(int page, int tag, AsyncHttpResponseHandler handler){
        RequestParams params = new RequestParams();
        params.put("page", page);
        params.put("tag", tag);
        ApiHttpClient.get("api/v1/threads", params, handler);
    }

    public static void getInitApi(AsyncHttpResponseHandler handler){
        ApiHttpClient.get("api/v1/user/init", handler);
    }
